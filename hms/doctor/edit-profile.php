...
if(isset($_POST['upload']))
{
	...
	$sql=mysqli_query($con,"Update doctors set pic='$destfile' where id='".$_SESSION['id']."'");
if($sql)
{
...
$sql=mysqli_query($con,"Update doctors set specilization='$docspecialization',doctorName='$docname',address='$docaddress',docFees='$docfees',contactno='$doccontactno',vtime='$docvtime' where id='".$_SESSION['id']."'");
if($sql)
{
...
<div class="form-group">
					...
					<input type="text" name="vtime" class="form-control" required="required"  value="<?php echo htmlentities($data['vtime']);?>">
														</div>
