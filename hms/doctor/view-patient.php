...
if(isset($_POST['submit']))
  {
   ...
   $pres=$_POST['pres'];
      ...
      $query.=mysqli_query($con, "insert   tblmedicalhistory(PatientID,BloodPressure,BloodSugar,Weight,Temperature,MedicalPres,addby)value('$vid','$bp','$bs','$weight','$temp','$pres','$dname')");
    if ($query) {
...
$retive=mysqli_query($con,"select * from doctors where id='$doc_id'");

$dname=mysqli_fetch_array($retive);
$doc_name=$dname['doctorName'];
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <tr>
    <th>Doc Name :</th>
    <td>
    <input type="text" name="dname" value="<?php  echo $doc_name;?>"  class="form-control wd-450"  readonly></td>
